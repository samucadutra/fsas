...
INSERT INTO pessoa (nome, logradouro, numero, bairro, cidade, estado, ativo) VALUES ('Samuel', 'Rua Correa Teixeira', '456', 'Realengo','Rio de Janeiro', 'RJ', true);
INSERT INTO pessoa (nome, logradouro, bairro, cidade, estado, ativo) VALUES ('Rita', 'Rua Procópio Gomes','Centro', 'Cruz Alta', 'RS', true);
INSERT INTO pessoa (nome, logradouro, numero, complemento, bairro, cep, cidade, estado, ativo) VALUES ('Sofia', 'Rua Frederico Maurer', '3853', 'casa 22', 'Boqueirão', '81670-020', 'Curitiba','PR', true);
